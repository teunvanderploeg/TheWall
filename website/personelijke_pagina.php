...
<html>
  ...
  <?php include('header.php'); ?>
    ...
    <a href='delete.php?id=<?php echo $afbeeldingen['id']; ?>'><button class='delete'>Delete</button></a>
    <!-- <a href='edit.php?id=<?php //echo $afspeelijst['id']; ?>'><button class='edit'>edit</button></a> -->
    <?php } ?>
      </div>
    <?php endforeach ?>
    </section>
